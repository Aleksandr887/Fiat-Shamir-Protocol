...
$(BIN_SERVER_DIR)/server: $(BUILD_SERVER_DIR)/server.o $(BUILD_LIB_DIR)/operations.o
	$(CC) -Wall -I $(SRC_LIB_DIR) -o $(BIN_SERVER_DIR)/server $(BUILD_SERVER_DIR)/server.o $(BUILD_LIB_DIR)/operations.o
...
$(BIN_CLIENT_DIR)/client: $(BUILD_CLIENT_DIR)/client.o $(BUILD_LIB_DIR)/operations.o
	$(CC) -Wall -I $(SRC_LIB_DIR) -o $(BIN_CLIENT_DIR)/client $(BUILD_CLIENT_DIR)/client.o $(BUILD_LIB_DIR)/operations.o
